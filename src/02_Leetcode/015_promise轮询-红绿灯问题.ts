function run() {
  const base = 1000
  const green = new Promise((re, rj) => {
    setTimeout(() => {
      console.log('[红灯]:')
      re()
    }, 1 * base)
  })
  const red = new Promise((re, rj) => {
    setTimeout(() => {
      console.log('[黄灯]:')
      re()
    }, 1 * base)
  })
  const yellow = new Promise((re, rj) => {
    // setTimeout(() => {
    //   console.log('[绿灯]:')
    //   // re()
    // }, 1 * base);
...
function run2() {
  const base = 1000
  const green = Promise.resolve().then(() => {
    setTimeout(() => {
      console.log('[绿灯]:', '6秒')
    }, 1 * base)
  })
  const red = Promise.resolve().then(() => {
    setTimeout(() => {
      console.log('[绿灯]:', '6秒')
    }, 1 * base)
  })
  const yellow = Promise.resolve().then(() => {
    setTimeout(() => {
      console.log('[绿灯]:', '6秒')
    }, 1 * base)
  })
